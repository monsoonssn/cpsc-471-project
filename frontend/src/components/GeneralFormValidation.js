...
export
    const RENTAL_PROPERTY_INIT_VALUES = {
        listingDate: "",
        sqFeet: "",
        streetNumber: "",
        unitNumber: "",
...
export
    const ADD_CONTACT_VALIDATION = yup.object({
